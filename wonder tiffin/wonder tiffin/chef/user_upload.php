...
<head>
	...
	<title>Admin | Wonder Tiffin</title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">Here you can Find all Customer Upload Menu Details and also Block Menu</p>
                            </div>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
													...
													<td><a class="pe-7s-lock" href="block_upload_menu.php?id=<?php echo $c['uid']; ?>&status=<?php echo $c['status']; ?> "><td>
										</tr>
