...
include 'db_con.php';
$r=mysqli_query($con,"SELECT `password1` FROM `member_info` WHERE `emailid1`='$username'");
...
<head>
	...
	<title>Chef/Wonder Tiffin</title>
...
$username=$_SESSION['username'];
	if(isset($_POST['submit']))
	{
		...
		if($oldpass==$k['password1'])
		{
			if($newpass == $compass)
			{
				$sql="UPDATE `member_info` SET `password1`='$newpass' WHERE `emailid1`='$username'";
